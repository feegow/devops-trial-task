...
```
Time: ~5s. No tests exist. NEVER commit `node_modules/`, `package-lock.json`.
...
runbooks/erro-5xx.md         # 5xx error runbook (Portuguese)
...
2. **NEVER commit**: `.coverage`, `report.xml`, Go binary, `node_modules/`, `package-lock.json`
